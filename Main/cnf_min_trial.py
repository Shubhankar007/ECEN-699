...
inputCNF = sys.argv[1]
clausess = cnf2pla_2.readCNFClauses(inputCNF)
clause_list = cnf2pla_2.getClauses(clausess)
#clause_list_length = len(clause_list)
paramss = cnf2pla_2.readCNFParams(inputCNF)
num_inputs = cnf2pla_2.getNumInputs(paramss)
cluster_size = 25
clause_list_split = [clause_list[x:(x+cluster_size)] for x in range(0, clause_list_length,(cluster_size))]
clause_list_split_length = len(clause_list_split)
#print(clause_list_split)
last_cluster_size = (clause_list_length)%cluster_size
#print(last_cluster_size)
PLA_terms_list = []
for current in range(clause_list_split_length):
